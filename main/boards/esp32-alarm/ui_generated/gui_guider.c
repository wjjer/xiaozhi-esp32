...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->screen_boot_del = true;
    ui->screen_home_del = true;
    ui->screen_app_grid_del = true;
    ui->screen_ai_del = true;
    ui->screen_study_del = true;
    ui->screen_alarm_del = true;
    ui->screen_weather_del = true;
    ui->screen_timer_del = true;
    ui->screen_stopwatch_del = true;
    ui->screen_focus_del = true;
    ui->screen_night_light_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_screen_boot(ui);
    setup_scr_screen_home(ui);
    events_init(ui);
    lv_screen_load(ui->screen_boot);
}
